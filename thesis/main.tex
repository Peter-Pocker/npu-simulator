...
\documentclass[
    ...
    blind,      % 可选项：   论文用于盲审请选择此项，将不会产生致谢(内容)、答辩委员会会议决议(内容)、
                %            常规评阅人名单(内容)；提交盲审时取消本行注释，正式提交时注释掉以显示致谢等
                % Optional:  For blind review, uncomment this line to hide Acknowledgements etc.; comment out for final submission
]{XJTU-thesis}
...
% 【盲审占位】正式提交时将占位行注释并启用下方真实信息
% \author{彭森}{Peng Sen}
\author{\hphantom{XXXX}}{\hphantom{XXXXXXXX}}
