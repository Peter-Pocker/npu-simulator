...
\begin{itemize}
  ...
  \item 单核：\texttt{mac\_units=256}，\texttt{vector\_units=64}，\texttt{clock\_freq\_mhz=1000}，\texttt{use\_analytical\_time=false}（由模拟器按\,4.1.3\,节的上界式估算，根据张量形状与核心计算资源数量推算计算周期）。
