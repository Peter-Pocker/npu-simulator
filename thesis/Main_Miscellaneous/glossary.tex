...
\newacronym[description=中央处理器]{cpu}{CPU}{Central Processing Unit}
...
\newacronym[description=先就绪先服务]{frfcfs}{FR-FCFS}{First Ready First Come First Served}
...
\newacronym[description=键值缓存]{kvcache}{KV Cache}{Key Value Cache}
...
\newacronym[description=片上网络的最小传输单位]{flit}{Flit}{Flow control digit}
